...
class VoiceController {
     ...
     * @returns {Promise}
     */
    static createViewCallDetails(callSid, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @param {Status1Enum} status (optional) Status to set the in-progress call to
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     ...
     * @param {Direction1Enum} direction (optional) The leg of the call audio will be played to
     ...
     * @param {DirectionEnum} direction (optional) The leg of the call to record
     ...
     * numbers separated with comma. e.g : +12223334444,+15556667777
