...
class PhoneNumberController {
     ...
     * @param {NumberTypeEnum} numberType (optional) The capability supported by the number.Number
     ...
     * @returns {Promise}
     */
    static createReleaseNumber(phoneNumber, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _queryBuilder = `${_baseUri}${'/incomingphone/releasenumber.json'}`;
